...
const mockGarments = [
  {
    ...
    status: 'en_proceso', intakeDate: '2026-04-01', deliveryDate: '2026-04-05',
    items: [{ id: 'I1', orderId: 'ORD-001', garmentName: 'Campera de Cuero', repairType: 'cierre', description: 'Cambiar cierre', price: 15000 }],
  },
  {
    id: 'ORD-002', orderNumber: 2, clientName: 'Juan P.', clientPhone: '11-1234-5678',
    status: 'entregado', intakeDate: '2026-04-02', deliveryDate: '2026-04-01',
