...
| Z6 | Frontend notificaciones (badge + panel en sidebar) | [Z6](docs/roadmap/Z6-frontend-notificaciones.md) | pendiente | media |
| Z7 | Conectar notificacion prenda lista con WhatsApp | [Z7](docs/roadmap/Z7-whatsapp-prenda-lista.md) | pendiente | alta |
| Z8 | Galeria de fotos en vista detalle de orden | [Z8](docs/roadmap/Z8-galeria-fotos-orden.md) | pendiente | media |
