...
> Ultima actualizacion: 2026-04-05 (sesion 7)
...
| M2 | Historial de chat persistente en DB | [M2](docs/roadmap/M2-chat-history-persistente.md) | **en progreso** | media |
...
| M7 | Tests E2E chatbot con API real (prompts + comportamiento) | [M7](docs/roadmap/M7-chatbot-e2e-tests.md) | pendiente | alta |
